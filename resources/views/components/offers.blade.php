<section class="bg-white dark:bg-gray-900">
    <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
        <div class="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
            <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Otkrijte naše najbolje</h2>
            <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Planira!</p>
        </div>
        <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
            ...
            <div
                ...
                <h3 class="mb-4 text-2xl text-center font-semibold">OSNOVNI PAKET - 03 MJESECA</h3>
                <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">S KANALIMA ZA ODRASLE.</p>
                ...
                <ul role="list" class="mb-8 space-y-4 text-left">
                    <li class="flex items-center space-x-3">
                        ...
                        <span>Netflix, Disney+, Amazon Prime, OCS..</span>
                    </li>
                    <li class="flex items-center space-x-3">
                        ...
                        <span>Bein Sports, Canal+, RMC..</span>
                    </li>
                    <li class="flex items-center space-x-3">
                        ...
                        <span>+50 000 Chaînes Mondiales</span>
                    </li>
                    <li class="flex items-center space-x-3">
